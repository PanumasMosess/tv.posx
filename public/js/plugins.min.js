...
const themeName = "North",
  themeLink = "https://goldeyes.net/buy/north/html",
  themeID = "7943169",
  JSUrl = document.currentScript.src,
  JSPath = JSUrl.split("/").slice(0, -1).join("/") + "/",
  jsonFile = JSPath + "security/valid.json",
  saveFile = JSPath + "security/save.php",
  verifyFile = "https://goldeyes.net/wpmedia/envato/api/verify.php";
var gesLive = !1,
  valid = !1;
const rdy = !0,
  domain = window.location.hostname,
  fullWebsite = "www." + domain;
gesLive = !(
  "file:" == window.location.protocol ||
  !window.location.host.replace(/localhost|127\.0\.0\.1|tv\.posx\.co/i, "") ||
  "localhost" === location.hostname ||
  "127.0.0.1" === location.hostname ||
  "tv.posx.co" === location.hostname
);
var failed = !1;
const fetchJson = async () => {
  try {
    if (!0 === gesLive) {
      const t = await fetch(jsonFile, { cache: "no-cache" }),
        e = await t.json();
      "Valid Successful" === e.status && e.website === domain
    ...
    t &&
      !0 === gesLive &&
      (document.body.classList.add("need-validation"), workValidation());
  }
};
// function workValidation() {
//   const t = document.createElement("div");
//   t.classList.add("verify-overlay"),
//     t.setAttribute("id", "verify-overlay"),
//     (t.style.cssText =
//       "\n\t\t\tposition: fixed;\n\t\t\twidth: 100vw;\n\t\t\theight: auto;\n\t\t\tmin-height: 100vh;\n\t\t\tz-index: 10000;\n\t\t\tleft:0;\n\t\t\ttop:0;\n\t\t\tbottom:0;\n\t\t\toverflow:scroll;\n\t\t\tpadding:50px 30px;\n\t\t\tbackground-color: #1E2026;\n\t\t\tbackground-image: linear-gradient(225deg, #252730 0%, #17181C 100%);\n\t\t\tdisplay:flex;\n\t\t\tjustify-content:center;\n\t\t\talign-items:center;\n\t\t\tflex-wrap: wrap;\n\t\t\tbox-sizing: border-box;\n\t\t\tcursor:default;\n\t\t"),
//     document.body.appendChild(t);
//   const e = document.createElement("div");
//   e.classList.add("verify-wrapper", "unselectable"),
//     e.setAttribute("id", "verify-wrapper"),
//     (e.style.cssText =
//       "\n\t\t\twidth: 600px;\n\t\t\theight: auto;\n\t\t\tz-index: 10010;\n\t\t\tbackground-color: #141519;\n\t\t\tpadding:60px 50px;\n\t\t\tborder-radius: 50px;\n\t\t\tposition:relative;\n\t\t\tdisplay:flex;\n\t\t\tjustify-content:center;\n\t\t\talign-items:center;\n\t\t\tflex-direction:column;\n\t\t\tflex-wrap:wrap;\n\t\t\tfont-family: Arial, Helvetica, sans-serif;\n\t\t\tcolor: white;\n\t\t\tfont-weight:400;\n\t\t\tbox-sizing: border-box;\n\t\t\t-webkit-font-smoothing: antialiased;\n\t\t"),
//     t.appendChild(e);
//   const n = document.createElement("img");
//   n.classList.add("verify-goldeyes-logo"),
//     n.setAttribute("id", "verify-goldeyes-logo"),
//     (n.src =
//       "https://goldeyes.net/wpmedia/envato/api/assets/envato-goldeyes-icons.svg"),
//     (n.style.cssText = "\n\t\t\twidth: 215px;\n\t\t\theight: auto;\n\t\t"),
//     e.appendChild(n);
//   const i = document.createElement("h5");
//   (i.innerText = "Verify Your Purchase Code"),
//     i.classList.add("verify-title"),
//     i.setAttribute("id", "verify-title"),
//     (i.style.cssText =
//       "\n\t\t\tfont-size: 24px;\n\t\t\tfont-weight:inherit;\n\t\t\tmargin: 30px 0 0;\n\t\t\ttext-align:center;\n\t\t\tline-height:1.5;\n\t\t"),
//     e.appendChild(i);
//   const o = document.createElement("form");
//   o.classList.add("verify-form"),
//     o.setAttribute("id", "verify-form"),
//     o.setAttribute("method", "get"),
//     (o.style.cssText =
//       "\n\t\t\tdisplay: block;\n\t\t\twidth: 100%;\n\t\t\theight:auto;\n\t\t\tmargin:30px 0 0;\n\t\t\tbox-sizing: border-box;\n\t\t"),
//     e.appendChild(o);
//   const s = document.createElement("input");
//   s.classList.add("purchase-verify-input"),
//     s.setAttribute("id", "purchase-verify-input"),
//     s.setAttribute("name", "purchaseCode"),
//     s.setAttribute("required", ""),
//     s.setAttribute("type", "text"),
//     s.setAttribute("placeholder", "Enter Your Purchase Code"),
//     (s.style.cssText =
//       "\n\t\t\tdisplay: block;\n\t\t\twidth: 100%;\n\t\t\theight:auto;\n\t\t\tpadding:30px;\n\t\t\tbackground-color: #292B32!important;\n\t\t\tborder-radius: 20px !important;\n\t\t\toutline: none!important;\n\t\t\tbox-shadow:none!important;\n\t\t\tborder:none!important;\n\t\t\tfont-size:18px;\n\t\t\tcolor: #FFFFFF;\n\t\t\tfont-weight:400;\n\t\t\tbox-sizing: border-box;\n\t\t"),
//     o.appendChild(s);
//   const r = document.createElement("input");
//   r.classList.add("verify-website-input"),
//     r.setAttribute("id", "verify-website-input"),
//     r.setAttribute("name", "website"),
...
//   a.classList.add("verify-themeID-name-input"),
//     a.setAttribute("id", "verify-themeID-name-input"),
//     a.setAttribute("name", "themeID"),
...
//   (d.innerHTML = "Verify Now"),
//     d.classList.add("verify-submit"),
//     d.setAttribute("id", "verify-submit"),
//     d.setAttribute("type", "submit"),
//     (d.style.cssText =
//       "\n\t\t\tdisplay: block;\n\t\t\twidth: 100%;\n\t\t\theight:auto;\n\t\t\tpadding:25px;\n\t\t\tbackground-color: #81B441!important;\n\t\t\tborder-radius: 20px !important;\n\t\t\toutline: none!important;\n\t\t\tbox-shadow:none!important;\n\t\t\tmargin: 20px 0 0 0;\n\t\t\tborder:none!important;\n\t\t\tfont-size:22px;\n\t\t\tcolor: #FFFFFF;\n\t\t\tfont-weight:400;\n\t\t\tbox-sizing: border-box;\n\t\t\tline-height:normal;\n\t\t\tcursor:pointer;\n\t\t\tdisplay:flex;\n\t\t\talign-items:center;\n\t\t\tjustify-content:center;\n\t\t"),
//     o.appendChild(d);
//   const l = document.createElement("p");
//   l.classList.add("verify-invalid-code"),
//     l.setAttribute("id", "verify-or-text"),
//     (l.style.cssText =
//       "\n\t\t\tfont-size: 22px;\n\t\t\tfont-weight:inherit;\n\t\t\tmargin: 20px 0 0;\n\t\t\tline-height:1.5;\n\t\t\tcolor: #F04040;\n\t\t\tdisplay:none;\n\t\t\ttext-align:center;\n\t\t\twidth:100%;\n\t\t\toverflow-wrap: break-word;\n\t\t"),
//     e.appendChild(l);
//   const c = document.createElement("div");
//   c.classList.add("verify-inner-div"),
//     c.setAttribute("id", "verify-inner-div"),
//     (c.style.cssText =
//       "\n\t\t\twidth:100%;\n\t\t\tdisplay:flex;\n\t\t\talign-items:center;\n\t\t\tjustify-content:between;\n\t\t\tmargin: 20px 0 0;\n\t\t\tcolumn-gap: 20px;\n\t\t"),
//     e.appendChild(c);
//   const p = document.createElement("a");
//   (p.innerText = "Report an issue"),
//     p.classList.add("verify-report-button"),
//     p.setAttribute("id", "verify-report-button"),
//     p.setAttribute("href", "https://goldeyes.net/support/"),
//     p.setAttribute("target", "_blank"),
//     (p.style.cssText =
//       "\n\t\t\twidth:100%;\n\t\t\tdisplay:inline-flex;\n\t\t\talign-items:center;\n\t\t\tjustify-content:center;\n\t\t\tpadding:23px 50px;\n\t\t\tline-height:normal;\n\t\t\tcolor:#FFFFFF;\n\t\t\tbackground-color:#993232;\n\t\t\tborder-radius: 20px;\n\t\t\tfont-size:18px;\n\t\t\ttext-decoration:none;\n\t\t"),
//     c.appendChild(p);
//   const u = document.createElement("a");
//   (u.innerText = "Get A License"),
//     u.classList.add("verify-report-button"),
//     u.setAttribute("id", "verify-report-button"),
//     u.setAttribute("href", themeLink),
//     u.setAttribute("target", "_blank"),
//     (u.style.cssText =
//       "\n\t\t\twidth:100%;\n\t\t\tdisplay:inline-flex;\n\t\t\talign-items:center;\n\t\t\tjustify-content:center;\n\t\t\tpadding:23px 50px;\n\t\t\tmargin-left:auto;\n\t\t\tline-height:normal;\n\t\t\tcolor:#FFFFFF;\n\t\t\tbackground-color:#2D3FC0;\n\t\t\tborder-radius: 20px;\n\t\t\tfont-size:18px;\n\t\t\ttext-decoration:none;\n\t\t"),
//     c.appendChild(u);
//   const h = document.createElement("a");
//   (h.innerText = "Where Is My Purchase Code? ↗"),
//     h.classList.add("verify-find-my-purchase-code"),
//     h.setAttribute("id", "verify-find-my-purchase-code"),
//     h.setAttribute(
//       "href",
...
//     y =
//       "Thanks for using North. Your website: <span style='color:#81B441'>" +
//       fullWebsite +
//       "</span>  has been registered by Gold Eyes Studio for security purposes. If you need support, contact us.";
//   (b.innerHTML = y),
//     b.classList.add("verify-find-my-purchase-code"),
//     b.setAttribute("id", "verify-find-my-purchase-code"),
//     (b.style.cssText =
//       "\n\t\t\twidth:100%;\n\t\t\ttext-align:center;\n\t\t\tmargin: 30px 0 0 0;\n\t\t\tline-height:1.5;\n\t\t\tcolor:#B6B6B6;\n\t\t\tfont-size:18px;\n\t\t\ttext-decoration:none;\n\t\t"),
//     e.appendChild(b);
//   var m = document.getElementById("verify-form");
//   m.addEventListener("submit", function (t) {
//     t.preventDefault();
//     var n = new FormData(m),
//       s = new XMLHttpRequest();
//     s.open("POST", verifyFile),
//       (s.onload = function () {
...
//             }
//             return !0;
//           })(t) && (responseString = JSON.parse(t)),
//           t.includes("Valid Successful"))
//         ) {
//           var n = new XMLHttpRequest();
//           n.open("POST", saveFile),
//             (n.onload = function () {
//               var s = n.responseText;
//               if ((console.log(s), s.includes("Save Successful"))) {
//                 c.remove(),
//                   o.remove(),
//                   l.remove(),
//                   h.remove(),
//                   t.includes("Valid Successful Again")
//                     ? ((i.innerHTML =
//                         "<span style='font-size:50px; color:#3D9CCB;'>Reconnected!</span><br> Thanks for using North!"),
//                       (b.innerHTML =
//                         "Your purchase code has been REACTIVATED on the <span style='color:#81B441;'>" +
//                         fullWebsite +
//                         "</span>. Modifying the security files may cause you to lose the purchase code."))
//                     : ((i.innerHTML =
//                         "<span style='font-size:50px; color:#81B441;'>Successful!</span><br> Thanks for using North!"),
//                       (b.innerHTML =
//                         "Your purchase code has been activated on the <span style='color:#81B441;'>" +
//                         fullWebsite +
//                         "</span>"));
//                 const n = document.createElement("button"),
//                   s = "Close";
//                 (n.innerHTML = s),
//                   n.classList.add("verify-close-button"),
//                   n.setAttribute("id", "verify-close-button"),
...
//                   (function () {
//                     if (!0 === valid) {
//                       const t = e.querySelector("#verify-close-button");
//                       t &&
...
//                   (l.innerHTML =
//                     "Your security files has been damaged or removed. Please re-download the theme again and replace the security files. The website and the purchase code were created by Gold Eyes Studio. Your website will reconnect when the security files are back."),
//                   l.querySelectorAll("br").forEach((t) => t.remove());
//             }),
//             n.send(t);
//         } else
//           (l.style.display = "block"),
//             (l.innerHTML =
//               t +
//               "- You can get a new license by clicking the Get a license button "),
//             l.querySelectorAll("br").forEach((t) => t.remove());
//       }),
//       s.send(n);
//   });
...
try {
  ...
  (n.style.cssText =
    ...
    e.appendChild(n),
    (n.innerHTML =
      "It has been detected that you have made an incorrect update on your website. For security reasons; Download the original files from Themeforest and replace the files you removed/changed. Your website will not work properly. Your website will be unusable when published. If you think there is a mistake, contact Gold Eyes Studio.");
}
var checked = !0;
...
!(function (n, t) {
  ...
  var t = "undefined" != typeof window,
    ...
    j = function (n) {
      for (var t, e = [], o = 0; (t = n.children[o]); o += 1)
    ...
    X = function (n, t) {
      W(n, f, y(n, t.data_sizes)),
        W(n, s, y(n, t.data_srcset)),
        W(n, l, y(n, t.data_src));
    },
    Y = {
      IMG: function (n, t) {
        D(n, function (n) {
          ...
          function (i) {
            !(function (n, t, e, o) {
              ...
              rn(t, e, o),
                N(t, e.class_error),
                A(t, m),
                C(e.callback_error, t, o),
                e.restore_on_error && H(t, J),
                i || nn(e, o);
            })(0, n, t, e),
              an(o);
          }
              ...
              L(n) ||
                ...
                (function (n, t, e, o) {
                  e.cancel_on_exit &&
                    ...
                    R(o, -1),
                    w(n),
                    C(e.callback_cancel, n, t, o));
                })(n, t, e, o),
                C(e.callback_exit, n, t, o));
            })(n.target, n, t, e);
      });
    },
    bn = function (n) {
...
!(function (a) {
        ...
        if (b <= m)
          ...
          n < 0 ? (n += k.topSpacing) : (n = k.topSpacing),
            k.currentTop != n &&
              ...
              "undefined" != typeof k.getWidthFrom &&
  ...
  window.addEventListener
    ...
    : window.attachEvent &&
      (window.attachEvent("onscroll", g), window.attachEvent("onresize", h)),
    (a.fn.sticky = function (b) {
      return i[b]
        ? i[b].apply(this, Array.prototype.slice.call(arguments, 1))
        : "object" != typeof b && b
        ? void a.error("Method " + b + " does not exist on jQuery.sticky")
...
!(function () {
  ...
  function g() {
    if (document.body) {
      var t = document.body,
        ...
        c = t.scrollHeight;
      if (
        ((i = document.compatMode.indexOf("CSS") >= 0 ? o : t),
        (e = t),
        v(),
        (n = !0),
        top != self)
        ...
        c > l &&
        (t.offsetHeight <= l || o.offsetHeight <= l) &&
        ((o.style.height = "auto"), i.offsetHeight <= l)
      ) {
        var u = document.createElement("div");
  ...
  function S(e, t, a, n) {
    ...
    if (
      ...
      (i = (i = t) > 0 ? 1 : -1),
      (l = (l = a) > 0 ? 1 : -1),
      (o.x !== i || o.y !== l) && ((o.x = i), (o.y = l), (y = []), (k = 0)),
      1 != r.accelerationMax)
    ) {
      var c = +new Date() - k;
      if (c < r.accelerationDelta) {
        var u = (1 + 30 / c) / 2;
        u > 1 && ((u = Math.min(u, r.accelerationMax)), (t *= u), (a *= u));
      }
      k = +new Date();
    }
    if (
      ...
      var s = e === document.body,
        d = function (o) {
          for (var i = +new Date(), l = 0, c = 0, u = 0; u < y.length; u++) {
            var f = y[u],
              m = i - f.start,
              h = m >= r.animationTime,
              w = h ? 1 : m / r.animationTime;
            r.pulseAlgorithm && (w = L(w));
          ...
          s
            ...
            t || a || (y = []),
            y.length ? K(d, e, n / r.frameRate + 1) : (b = !1);
        };
      K(d, e, 0), (b = !0);
    }
  }
  function x(t) {
    ...
    if (
      /input|textarea|select|embed/i.test(a.nodeName) ||
      a.isContentEditable ||
      t.defaultPrevented ||
      o
    )
    ...
    switch ((l == document.body && (v = window.innerHeight), t.keyCode)) {
      ...
      case p:
        ...
        break;
      case w:
        var g = l.scrollHeight - l.scrollTop - v;
        i = g > 0 ? g + 10 : 0;
        break;
      case c:
        n = -r.arrowScroll;
  ...
  function T(e, t) {
    for (var r = e.length; r--; ) D[C(e[r])] = t;
    return t;
  }
  function z(e) {
    var t = [],
    ...
    do {
      ...
      if ((t.push(e), r === e.scrollHeight)) {
        if (!a || i.clientHeight + 10 < r) return T(t, document.body);
      } else if (
  ...
  var X = /chrome/i.test(window.navigator.userAgent);
  "onmousewheel" in document &&
    ...
    A("mousewheel", function (t) {
      ...
      if (
        ...
        t.defaultPrevented ||
        N(e, "embed") ||
        (N(a, "embed") && /\.pdf/i.test(a.src))
      )
        return !0;
      var i = t.wheelDeltaX || 0,
        c = t.wheelDeltaY || 0;
      if (
        (i || c || (c = t.wheelDelta || 0),
        !r.touchpadSupport &&
          (function (e) {
            if (e) {
              (e = Math.abs(e)), l.push(e), l.shift(), clearTimeout(M);
              var t = l[0] == l[1] && l[1] == l[2],
                r = E(l[0], 120) && E(l[1], 120) && E(l[2], 120);
              return !(t || r);
            }
          })(c))
      )
        return !0;
      Math.abs(i) > 1.2 && (i *= r.stepSize / 120),
        Math.abs(c) > 1.2 && (c *= r.stepSize / 120),
        S(o, -i, -c);
    }),
    A("load", g));
})();
